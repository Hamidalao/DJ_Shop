...
<body>
    <div class="container">
        ...
        <p><a href="../../index.php" class="btn btn-secondary">Retour</a>

            <a href="admin_affiche.php" class="btn btn-secondary">retour affichage</a>
        </p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="modification.php?type=<?= $articleType ?>&name=<?= $article['name'] ?>&id=<?= $article['id'] ?>"
                            class="btn btn-primary">Modifier</a>
                        <a href="suppression.php?type=<?= $articleType ?>&id=<?= $article['id'] ?>"
